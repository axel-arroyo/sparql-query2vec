...
/**
 * Process a SPARQL query string and extract sets of tables, joins,predicates,
 * and uriPredicates
...
public class QueryFeatureExtractor {
    ...
    /**
     * Logic for subject var, predicate uri, object String literal like
     * (Var1.foaf:name, 'daniel' )
     *
    ...
    /**
     * Logic for subject var, predicate uri, object int literal like (Var1.foaf:age,
     * 29 )
     *
     * @param subject   Subject of the triple pattern frame
     * @param predicate Predicate of the triple pattern frame
    ...
    /**
     * Logic for subject literal, predicate uri, object var literal like (29
     * foaf:age, var )
     *
     * @param subject   Subject of the triple pattern frame
     * @param predicate Predicate of the triple pattern frame
    ...
    /**
     * Logic for subject var, predicate uri, object int literal like (Var1.rdf:type,
     * foaf:Person )
     *
     * @param subject   Subject of the triple pattern frame
     * @param predicate Predicate of the triple pattern frame
    ...
    private void processVarPredUri(Node subject, Node predicate, Node object) {
        ...
        String hash = String.valueOf(pred.get("col")).concat(String.valueOf(pred.get("operator")))
    ...
    /**
     * Logic for subject uri, predicate uri, object int var like (:Boat :builtBy
     * ?var1 )
     *
     * @param subject   Subject of the triple pattern frame
     * @param predicate Predicate of the triple pattern frame
        ...
        try {
                    ...
                    new ElementVisitorBase() {
                        ...
                        public void visit(ElementPathBlock el) {
                            ...
                            while (triples.hasNext()) {
                                ...
                                String tripleHash = t.getPath() != null
                                        ? t.getSubject() + " " + t.getPath() + " " + t.getObject()
            ...
            for (TriplePath t : tpf.values()) {
                ...
                // LIT_Numeric URI VAR
                        ...
                        subject.getLiteralDatatype().getClass() == XSDBaseNumericType.class && object.isVariable()
                        && predicate.isURI()) {
            ...
            System.out.println("Error processing query: " + query + " " + e.getMessage());
            // Add empty list to avoid errors in the future.
            result.put("queryTables", new ArrayList<>());
            result.put("queryVariables", new ArrayList<>());
            result.put("queryJoins", new ArrayList<>());
            result.put("queryPredicates", new ArrayList<>());
            result.put("queryPredicatesUris", new ArrayList<>());
            result.put("queryJoinsV1Vec", new ArrayList<>());
        }
        return result;
    }

    public ArrayList<ArrayList> getRepresentationJoins(
            HashMap<String, HashMap<String, ArrayList<String>>> queryJoinsV1Nodes) {
