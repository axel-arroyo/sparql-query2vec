...
public class AlgebraFeatureExtractor {
    ...
    private void walkAlgebraTreeRecursive(Op op, final int level) {
        ...
        if (op instanceof OpConditional) {
            ...
            if (!visited.get(arg0.getLeft()))
                walkAlgebraTreeRecursive(arg0.getLeft(), level + 1);
            if (!visited.get(arg0.getRight()))
                walkAlgebraTreeRecursive(arg0.getRight(), level + 1);
        ...
        if (op instanceof OpDiff) {
            ...
            if (!visited.get(arg0.getLeft()))
                walkAlgebraTreeRecursive(arg0.getLeft(), level + 1);
            if (visited.get(arg0.getRight()) == false)
                walkAlgebraTreeRecursive(arg0.getRight(), level + 1);
